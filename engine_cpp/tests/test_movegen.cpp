...
TEST_F(MoveGenTest, EnPassant) {
    ...
    auto pos = Position::from_fen("rnbqkbnr/ppp1pppp/8/3pP3/8/8/PPPP1PPP/RNBQKBNR w KQkq d6 0 3");
    EXPECT_TRUE(has_move(pos, "e5d6"));
}

TEST_F(MoveGenTest, EnPassantBlack) {
    // Black pawn on d4, white just played e2-e4 → ep square e3.
    auto pos = Position::from_fen("rnbqkbnr/ppp1pppp/8/8/3pP3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 2");
...
TEST_F(MoveGenTest, CastlingBlockedByCheck) {
    ...
    auto pos = Position::from_fen("r3k2r/pppp1ppp/8/4q3/8/8/PPPP1PPP/R3K2R w KQkq - 0 1");
    ...
    auto pos2 = Position::from_fen("r3k2r/pppppppp/8/8/1b6/8/PPPPPPPP/R3K2R w KQkq - 0 1");
    // Bishop on b4 attacks e1? No, d2 pawn blocks.
    // Use a direct check position.
    auto pos3 = Position::from_fen("r3k2r/pppppppp/8/8/8/4q3/PPPPPPPP/R3K2R w KQkq - 0 1");
    // e3 queen doesn't attack e1 because e2 pawn blocks.
    // Let me construct a proper check position.
    auto pos4 = Position::from_fen("4k3/8/8/8/8/8/8/R3K2r w Q - 0 1");
...
TEST_F(MoveGenTest, CastlingThroughAttack) {
    ...
    auto pos = Position::from_fen("4k3/8/8/8/5b2/8/8/R3K2R w KQ - 0 1");
    // Bishop on f4 attacks... let me check. f4 bishop goes diag to c1, e3, g5, h6 and also e5, d6,
    // c7, b8. f4 doesn't directly attack f1. Let me use a different setup.
    auto pos2 = Position::from_fen("4k3/8/8/8/8/5n2/8/R3K2R w KQ - 0 1");
    ...
    auto pos3 = Position::from_fen("4k3/8/8/8/8/8/5r2/R3K2R w KQ - 0 1");
